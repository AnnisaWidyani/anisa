    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          <h3 class="card-title">Data table of flute</h3>
          <a href="{{route('news5.create')}}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Create</a>
        </div>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="table-author" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('news5.edit', [$newss->id]) }}" class="btn btn-warning float-left m-1">Edit</a>
                <form class="float-left m-1" action="{{ route('news5.destroy', [$newss->id]) }}" method="POST">
                  @method('delete')
                  @csrf
