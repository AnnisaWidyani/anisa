...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <form action="{{ route('news1.store') }}" method="POST" enctype="multipart/form-data">
                @CSRF
                <div class="card-body">
                    <div class="col-20">
                        <div class="col-20">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="piano Title">
